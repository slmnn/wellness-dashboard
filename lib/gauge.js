...
/*
		if(this.options.useTimeFormatting === true) {
				var secs = num;
...
*/
  ...
  TextRenderer = (function() {
    ...
    TextRenderer.prototype.render = function(gauge) {
			if(this.el.getAttribute("timeformat") === 'true') {
	      return this.el.innerHTML = secondsToString(gauge.displayedValue);
			}
