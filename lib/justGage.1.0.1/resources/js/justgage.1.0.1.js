...
JustGage = function(config) { 
  ...
  this.config = 
  {
    ...
    title : (config.title) ? config.title : "Title",
		...
		// Convert value from seconds to HH.MM
//		convertValue : (config.convertValue != null) ? config.convertValue : false,
    
    // titleFontColor : string
    // color of gauge title 
    titleFontColor : (config.titleFontColor) ? config.titleFontColor : "#010101",
...
//  var titleFontSize = ((widgetH / 6.4) > 16) ? (widgetH / 6.4) : 16;
//  var titleX = dx + widgetW / 2;
//  var titleY = dy + widgetH / 1.8;
  
  // value 
  var valueFontSize = 0; //((widgetH / 6.4) > 16) ? (widgetH / 6.4) : 16;
  ...
  // value
//	if(this.config.convertValue != true) {
...
/*
	  ...
	  this.txtValue = this.canvas.text(this.params.valueX, this.params.valueY, secondsToString(this.originalValue));
		this.txtValue. attr({
    	"font-size":this.params.valueFontSize,
    	"font-weight":"bold",
    	"font-family":"Arial",
